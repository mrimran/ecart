...
class MW_Mcore_Block_Adminhtml_Notification_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('mcore_data') && Mage::registry('mcore_data')->getId() ) {
            return Mage::helper('mcore')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('mcore_data')->getId()));
        } else {
