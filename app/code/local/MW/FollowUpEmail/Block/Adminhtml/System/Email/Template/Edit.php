...
class MW_FollowUpEmail_Block_Adminhtml_System_Email_Template_Edit extends Mage_Adminhtml_Block_Widget
{
    ...
    {
        parent::__construct();
        $this->setTemplate('mw_followupemail/system/email/template/edit.phtml');
    }
