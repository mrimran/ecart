...
class MW_FollowUpEmail_Model_Followupemailrule_Rule_Condition_Product_Found
    extends Mage_SalesRule_Model_Rule_Condition_Product_Combine
{
    ...
    public function loadValueOptions()
    {
        $this->setValueOption(array(
            1 => Mage::helper('followupemail')->__('FOUND'),
            0 => Mage::helper('followupemail')->__('NOT FOUND')
        ));
        return $this;
    }
    ...
    public function asHtml()
    {
        $html = $this->getTypeElement()->getHtml().
            Mage::helper('followupemail')->__("If an item is %s in the rule with %s of these conditions true:",
