...
class MW_Mcore_Block_Adminhtml_Mcore_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('mcoreGrid');
      $this->setDefaultSort('mcore_id');
  ...
  {
      $collection = Mage::getModel('mcore/mcore')->getCollection();
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('mcore')->__('Title'),
          'align'     =>'left',
          'index'     => 'title',
      ));
      ...
      $this->addColumn('content', array(
			'header'    => Mage::helper('mcore')->__('Item Content'),
			'width'     => '150px',
			'index'     => 'content',
      ));
	  */
