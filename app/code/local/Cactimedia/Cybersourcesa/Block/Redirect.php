...
class Cactimedia_Cybersourcesa_Block_Redirect extends Mage_Core_Block_Abstract
{
	protected function _toHtml()
	{
		...
		$html.= $form->toHtml();
		#die($form->toHtml());
        $html.= '<script type="text/javascript">document.getElementById("cybersourcesa_payment_checkout").action="'.Mage::getBaseUrl().'cybersource_wm/web/payment_confirmation.php";document.getElementById("cybersourcesa_payment_checkout").submit();</script>';
        $html.= '</body></html>';
