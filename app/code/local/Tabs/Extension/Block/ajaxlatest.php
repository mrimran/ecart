 ...
 */
class Tabs_Extension_Block_Ajaxlatest extends Mage_Catalog_Block_Product_Abstract
{
    /**
   ...
   protected function getProductCollectionLatest($category)
    ...
    {
        $this->getProductCollectionLatest($id)->addAttributeToSelect($code);
        return $this;
    }
    ...
    public function getCacheTags()
    {
        return array_merge(
            parent::getCacheTags(),
            $this->getItemsTags($this->getProductCollectionLatest($id))
        );
    }
