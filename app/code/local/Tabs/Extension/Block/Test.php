...
class Tabs_Extension_Block_Test extends Mage_Catalog_Block_Product_Abstract {

    protected $_defaultToolbarBlock = 'catalog/product_list_toolbar';
    protected $_productsCount = null;
    const DEFAULT_PRODUCTS_COUNT = 10;

    public function getLoadedProductCollection($id)
    { 
    ...
    protected function _getProductCollection($id)
    {
     ...
     public function getLoadedProductCollectionnew()
    {
      ...
      public function getLoadedProductCollectionbrand($id)
    {
