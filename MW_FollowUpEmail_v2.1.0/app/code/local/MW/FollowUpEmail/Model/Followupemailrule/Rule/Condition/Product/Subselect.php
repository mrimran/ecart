...
class MW_FollowUpEmail_Model_Followupemailrule_Rule_Condition_Product_Subselect
    extends Mage_SalesRule_Model_Rule_Condition_Product_Combine
{
    public function __construct()
    {
        parent::__construct();
        $this->setType('followupemail/followupemailrulerule_condition_product_subselect')
            ->setValue(null);
    }
